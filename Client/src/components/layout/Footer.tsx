        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-2xl font-bold bg-gradient-to-r from-blue-400 to-emerald-400 bg-clip-text text-transparent">
                LedgerSense
              </span>
            </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/tutorials" className="text-gray-300 hover:text-white transition">
                  Tutorials
                </Link>
              </li>
              <li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@ledgersense.com" className="text-gray-300 hover:text-white transition">
